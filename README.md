...
Este projeto é um site de notícias sobre exploração espacial, que consome dados da **Spaceflight News API**. O sistema permite que os usuários leiam as últimas notícias relacionadas a viagens espaciais e ciência espacial, com opções de pesquisa e filtros para facilitar a busca de artigos.
